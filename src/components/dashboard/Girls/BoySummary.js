    ...
    return(
            <div className="card center">
                ...
                <div className="card-content">
                    ...
                    <button className="waves-effect btn-floating waves-light btn-large white" onClick={() => handleClickToLikeBoy()}><i class="large material-icons blue-text text-darken-4">check</i></button>
                </div>
            </div>
    )
